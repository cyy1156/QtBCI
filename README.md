...
**更新日期**：2026-05-02（工程结构、类名与依赖说明已于 2026-05-13 按当前源码校对增补，下文历史段落均保留。）
...
- 可选 UDP 遥测：预处理分窗（PBC1）、FFT（PBF1）、PSD 频段（PBP1）发往本机或远端接收端（见 `docs/` 下 UDP 专题）
