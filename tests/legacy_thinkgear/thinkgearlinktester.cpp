    ...
    : QObject{parent}
{
    ...
    connect(m_assembler, &SerialEegFrameAssembler::frameReady, this, &ThinkGearLinkTester::onFrameReady);
    connect(m_assembler, &SerialEegFrameAssembler::frameReady, m_parser, &SerialEegPayloadParser::parseFrame);
    connect(m_parser, &SerialEegPayloadParser::rawReceived, m_converter, &RawToUvProcessor::onRaw);
    connect(m_converter, &RawToUvProcessor::uvValueReady, this, &ThinkGearLinkTester::onRawUvReady);
    connect(m_parser, &SerialEegPayloadParser::parseWarning,
    ...
    connect(m_parser, &SerialEegPayloadParser::rawReceived, this, &ThinkGearLinkTester::onRawInt16Ready);
...
void ThinkGearLinkTester::onRawUvReady(double uv)
{
    ...
    li.wallMs = ms;
    li.tsMs = QDateTime::fromMSecsSinceEpoch(ms, QTimeZone::utc())
