...
template <> constexpr inline auto AcquisitionEngine::qt_create_metaobjectdata<qt_meta_tag_ZN17AcquisitionEngineE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'onRawInt16'
        QtMocHelpers::SlotData<void(qint16)>(14, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::Short, 15 },
        }}),
        // Slot 'onSignalQuality'
        QtMocHelpers::SlotData<void(quint8)>(16, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::UChar, 17 },
        }}),
        // Slot 'onUvReady'
...
void AcquisitionEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->onRawInt16((*reinterpret_cast<std::add_pointer_t<qint16>>(_a[1]))); break;
        case 7: _t->onSignalQuality((*reinterpret_cast<std::add_pointer_t<quint8>>(_a[1]))); break;
        case 8: _t->onUvReady((*reinterpret_cast<std::add_pointer_t<double>>(_a[1]))); break;
        default: ;
        }
    }
