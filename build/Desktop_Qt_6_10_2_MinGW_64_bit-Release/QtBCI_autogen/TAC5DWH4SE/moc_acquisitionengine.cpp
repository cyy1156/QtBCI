...
template <> constexpr inline auto AcquisitionEngine::qt_create_metaobjectdata<qt_meta_tag_ZN17AcquisitionEngineE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'start'
        QtMocHelpers::SlotData<void(const QString &, qint32)>(10, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QString, 11 }, { QMetaType::Int, 12 },
        }}),
        // Slot 'startWithConfig'
        QtMocHelpers::SlotData<void(const SerialPortConfig &)>(13, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 14, 15 },
        }}),
        // Slot 'stop'
        ...
        QtMocHelpers::SlotData<void(quint8)>(19, 2, QMC::AccessPrivate, QMetaType::Void, {{
            { QMetaType::UChar, 20 },
        }}),
        // Slot 'onUvReady'
...
void AcquisitionEngine::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->start((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<qint32>>(_a[2]))); break;
        case 5: _t->startWithConfig((*reinterpret_cast<std::add_pointer_t<SerialPortConfig>>(_a[1]))); break;
        case 6: _t->stop(); break;
        case 7: _t->onRawInt16((*reinterpret_cast<std::add_pointer_t<qint16>>(_a[1]))); break;
        case 8: _t->onSignalQuality((*reinterpret_cast<std::add_pointer_t<quint8>>(_a[1]))); break;
        case 9: _t->onUvReady((*reinterpret_cast<std::add_pointer_t<double>>(_a[1]))); break;
        default: ;
        }
    }
